...
import { CheckPostUseCase } from "./application/use-cases/check-post.use-case";
...
@Module({
    imports:[ TypeOrmModule.forFeature([Post]), forwardRef(() => LikesModule), UsersModule, 
        CommentsModule ,CqrsModule],
    providers:[PostsQueryRepo, PostsRepository, CheckPostUseCase, CreatePostForBlogUseCase, 
